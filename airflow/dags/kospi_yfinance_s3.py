...
with DAG(
    dag_id='kospi_yfinance_s3',
    start_date=datetime(2024, 11, 1),
    schedule_interval='5 1-6 * * 1-5',
    max_active_runs=1,
    catchup=False,
    default_args={
        'retries': 1,
    ...
    input_key = 'domestic/top_300_kospi_stocks.parquet'
    parquet_key = f"domestic/domestic_kospi_300_by_marketcap.parquet"
    csv_key = f"domestic/domestic_kospi_300_by_marketcap.csv"
    ...
    trigger_next_dag = TriggerDagRunOperator(
        task_id="trigger_kospi_s3_dw",
        trigger_dag_id="kospi_s3_dw",
